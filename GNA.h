...
class GNA : public SST::Component {
   public:
    ...
    SST_ELI_DOCUMENT_SUBCOMPONENT_SLOTS({"memory", "Interface to memory (e.g., caches)",
   ...
   public:
    ...
    auto getNeuron(int n) -> neuron * { return &neurons[n]; }
   ...
   private:
    ...
    virtual auto clockTic(SST::Cycle_t) -> bool;

    auto deliverBWPs() -> bool;
